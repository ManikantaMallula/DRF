...
##            perm=list(itertools.permitations(i,3))
##            for k in pern:
##                if k in comb:
##                    print("user 1 win")
##                    game==False
##
##    user2=int(input("select any 1 position: ")
##    if user2 in mylist:
##              user2=int(input("position already taken,try another : ")
##        mylist.append(user2)
##        l2.append(mylist)
##        comb=list(itertools.combinations(l2,3)
##        for i in combinations:
##                  perm=list(itertools.permitations(i,3))
##                  if k in perm:
##                      if k in comb:
